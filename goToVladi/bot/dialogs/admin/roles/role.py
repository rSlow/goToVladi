...
from goToVladi.bot.states.admin import RoleSG, AddUserToRoleSG
from goToVladi.bot.utils.dialog_factory import choice_window_factory
from goToVladi.bot.views import buttons as b
from goToVladi.core.data.db.dao.role import RoleDao
from goToVladi.core.data.db.dao.user import UserDao
from goToVladi.core.data.db.dto import id_getter
...
async def delete_user_from_role(
    ...
    await role_dao.remove_user(role.id, user.id)
